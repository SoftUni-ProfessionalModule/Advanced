    ...
    public class HeiganDance
    {
        ...
        public static void Main()
        {
            ...
            while (true)
            {
                ...
                {
                    if (!isPlayerTryEscape(playerPos, spellCol, spellRow))
                    {
                        switch (spell)
                        {
                            case "Cloud":
        ...
        private static bool isPlayerTryEscape(int[] playerPos, int spellCol, int spellRow)
        {
